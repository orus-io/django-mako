...
class MakoBackend(BaseEngine):
    ...
    def __init__(self, parameters):
        ...
        self.Template = import_string(options.pop(
    ...
    def from_string(self, template_code):
        ...
        """
        try:
            return self.Template(self.engine.from_string(template_code))
    ...
    def get_template(self, template_name):
        ...
        """
        try:
            return self.Template(self.engine.get_template(template_name))
